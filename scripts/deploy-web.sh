#!/usr/bin/env bash
################################################################################
# deploy-web.sh - Deploy Architecture Decision Record to GitHub Pages
#
# SYNOPSIS
...
GITHUB_REPO="architecture-decision-record"
GITHUB_PAGES_URL="https://bordenet.github.io/architecture-decision-record/"
...
echo ""
echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║   Architecture Decision Record - Web Deployment          ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
# Note: architecture-decision-record doesn't require a build step
# The app-bundle.js is pre-committed to the repo
