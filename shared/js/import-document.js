 ...
 * Handles importing existing Architecture Decision Records from Word/Google Docs via paste
 */
...
const DOC_TYPE = 'Architecture Decision Record';
const DOC_TYPE_SHORT = 'ADR';
...
export function showImportModal() {
  ...
  saveBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      const title = titleMatch ? titleMatch[1].replace(/^ADR:\s*/i, '').trim() : `Imported ${DOC_TYPE_SHORT}`;
