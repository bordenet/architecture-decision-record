 ...
 * @module prompts
 *
 * Manages workflow configuration and prompt generation for Architecture Decision Records.
 ...
 * @param {Object} formData - Form data from project (title, status, context)
