# Contributing to Architecture Decision Record Assistant
...
2. **Clone** your fork: `git clone https://github.com/YOUR-USERNAME/architecture-decision-record.git`
...
- Check existing [Issues](https://github.com/bordenet/architecture-decision-record/issues)
- Read the [Architecture Decision Record Standard](https://github.com/joelparkerhenderson/architecture-decision-record)
- Review [Project Requirements Assistant](https://github.com/bordenet/product-requirements-assistant) for similar patterns
...
**Thank you for contributing to Architecture Decision Record Assistant!**
